...
<body>
    ...
    <div class="container my-4">
        ...
        <form id="filter_form">
            ...
            <select id="album_select" name="album" onchange="updateSongList()" class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <select id="genre_select" name="genre" onchange="updateSongList()" class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
